...
#ifndef VERILATED_VRISCV_TOP_BIRISCV_CSR__SB0_H_
#define VERILATED_VRISCV_TOP_BIRISCV_CSR__SB0_H_  // guard

#include "systemc"
#include "verilated_sc.h"
#include "verilated.h"
class Vriscv_top_biriscv_csr_regfile;


class Vriscv_top__Syms;

class alignas(VL_CACHE_LINE_BYTES) Vriscv_top_biriscv_csr__SB0 final : public VerilatedModule {
  public:
    // CELLS
    Vriscv_top_biriscv_csr_regfile* u_csrfile;
    ...
    CData/*2:0*/ __PVT__init_done;
    CData/*0:0*/ __VdfgRegularize_h7babc46f_0_1;
    ...
    // CONSTRUCTORS
    Vriscv_top_biriscv_csr__SB0(Vriscv_top__Syms* symsp, const char* v__name);
    ~Vriscv_top_biriscv_csr__SB0();
    VL_UNCOPYABLE(Vriscv_top_biriscv_csr__SB0);
