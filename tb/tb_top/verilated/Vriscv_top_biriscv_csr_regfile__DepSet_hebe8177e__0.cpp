...
VL_INLINE_OPT void Vriscv_top_biriscv_csr_regfile___ico_sequent__TOP__v__u_core__u_csr__u_csrfile__0(Vriscv_top_biriscv_csr_regfile* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vriscv_top_biriscv_csr_regfile___ico_sequent__TOP__v__u_core__u_csr__u_csrfile__0\n"); );
...
VL_INLINE_OPT void Vriscv_top_biriscv_csr_regfile___nba_sequent__TOP__v__u_core__u_csr__u_csrfile__0(Vriscv_top_biriscv_csr_regfile* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vriscv_top_biriscv_csr_regfile___nba_sequent__TOP__v__u_core__u_csr__u_csrfile__0\n"); );
    Vriscv_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    ...
    } else if ((0U != vlSymsp->TOP__v__u_core__u_csr.__PVT__interrupt_w)) {
        vlSelfRef.__PVT__irq_priv_q = 3U;
    }
}

VL_INLINE_OPT void Vriscv_top_biriscv_csr_regfile___nba_sequent__TOP__v__u_core__u_csr__u_csrfile__1(Vriscv_top_biriscv_csr_regfile* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vriscv_top_biriscv_csr_regfile___nba_sequent__TOP__v__u_core__u_csr__u_csrfile__1\n"); );
    Vriscv_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    if (vlSymsp->TOP.__Vcellinp__v__rst_i) {
        ...
        if ((((0x7b2U == (IData)(vlSelfRef.__PVT__csr_waddr_i)) 
              | (0x8b2U == (IData)(vlSelfRef.__PVT__csr_waddr_i))) 
             & (~ (0U != (IData)(vlSymsp->TOP__v__u_core.__PVT__csr_writeback_exception_w))))) {
            if (VL_UNLIKELY(((0U == (0xff000000U & vlSymsp->TOP__v__u_core__u_issue.__PVT__u_pipe0_ctrl__DOT__csr_wdata_wb_q))))) {
                VL_FINISH_MT("../../src/core/biriscv_csr_regfile.v", 551, "");
                VL_FINISH_MT("../../src/core/biriscv_csr_regfile.v", 552, "");
            } else if (VL_UNLIKELY(((0x1000000U == 
                                     (0xff000000U & vlSymsp->TOP__v__u_core__u_issue.__PVT__u_pipe0_ctrl__DOT__csr_wdata_wb_q))))) {
                VL_WRITEF_NX("%c",0,8,(0xffU & vlSymsp->TOP__v__u_core__u_issue.__PVT__u_pipe0_ctrl__DOT__csr_wdata_wb_q));
            }
        }
        ...
        vlSelfRef.__PVT__csr_satp_q = 0U;
        vlSelfRef.__PVT__csr_sscratch_q = 0U;
        vlSelfRef.__PVT__csr_mip_next_q = ((((IData)(vlSymsp->TOP__v__u_core.__PVT__csr_opcode_valid_w) 
                                             & ((0x344U 
                                                 == 
    ...
    } else if ((((0x344U == (IData)(vlSelfRef.__PVT__csr_waddr_i)) 
                 | (0x144U == (IData)(vlSelfRef.__PVT__csr_waddr_i))) 
                | (0U != (IData)(vlSymsp->TOP__v__u_core.__PVT__csr_writeback_exception_w)))) {
        vlSelfRef.__PVT__csr_mip_upd_q = 0U;
    }
...
VL_INLINE_OPT void Vriscv_top_biriscv_csr_regfile___nba_sequent__TOP__v__u_core__u_csr__u_csrfile__2(Vriscv_top_biriscv_csr_regfile* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vriscv_top_biriscv_csr_regfile___nba_sequent__TOP__v__u_core__u_csr__u_csrfile__2\n"); );
    Vriscv_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
