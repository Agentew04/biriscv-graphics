...
VL_INLINE_OPT void Vriscv_top_riscv_top___ico_sequent__TOP__v__0(Vriscv_top_riscv_top* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+      Vriscv_top_riscv_top___ico_sequent__TOP__v__0\n"); );
...
VL_INLINE_OPT void Vriscv_top_riscv_top___ico_sequent__TOP__v__1(Vriscv_top_riscv_top* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+      Vriscv_top_riscv_top___ico_sequent__TOP__v__1\n"); );
    Vriscv_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
...
VL_INLINE_OPT void Vriscv_top_riscv_top___ico_sequent__TOP__v__2(Vriscv_top_riscv_top* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+      Vriscv_top_riscv_top___ico_sequent__TOP__v__2\n"); );
    Vriscv_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    vlSelfRef.__PVT__dcache_accept_w = ((~ (IData)(vlSymsp->TOP__v__u_dcache.__PVT__u_mux__DOT__hold_w)) 
                                        & ((IData)(vlSymsp->TOP__v__u_core.__PVT__u_lsu__DOT__mem_cacheable_q)
                                            ? (IData)(vlSymsp->TOP__v__u_dcache.__PVT__mem_cached_accept_w)
                                            : ((2U 
                                                != (IData)(vlSymsp->TOP__v__u_dcache.__PVT__u_uncached__DOT__u_req__DOT__count_q)) 
                                               & (2U 
                                                  != (IData)(vlSymsp->TOP__v__u_dcache.__PVT__u_uncached__DOT__u_resp__DOT__count_q)))));
}

VL_INLINE_OPT void Vriscv_top_riscv_top___act_sequent__TOP__v__0(Vriscv_top_riscv_top* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+      Vriscv_top_riscv_top___act_sequent__TOP__v__0\n"); );
    Vriscv_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    if (vlSymsp->TOP__v__u_dcache.__PVT__u_mux__DOT__cache_access_q) {
...
VL_INLINE_OPT void Vriscv_top_riscv_top___nba_sequent__TOP__v__0(Vriscv_top_riscv_top* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+      Vriscv_top_riscv_top___nba_sequent__TOP__v__0\n"); );
    Vriscv_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    if (vlSymsp->TOP__v__u_dcache.__PVT__u_mux__DOT__cache_access_q) {
...
VL_INLINE_OPT void Vriscv_top_riscv_top___nba_comb__TOP__v__0(Vriscv_top_riscv_top* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+      Vriscv_top_riscv_top___nba_comb__TOP__v__0\n"); );
    Vriscv_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    vlSelfRef.__PVT__dcache_data_rd_w = ((IData)(vlSymsp->TOP__v__u_dcache.__PVT__u_mux__DOT__cache_access_q)
...
VL_INLINE_OPT void Vriscv_top_riscv_top___nba_comb__TOP__v__1(Vriscv_top_riscv_top* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+      Vriscv_top_riscv_top___nba_comb__TOP__v__1\n"); );
    Vriscv_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
