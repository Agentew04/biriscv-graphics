...
#ifndef VERILATED_VRISCV_TOP_BIRISCV_CSR_REGFILE_H_
#define VERILATED_VRISCV_TOP_BIRISCV_CSR_REGFILE_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vriscv_top_biriscv_csr_regfile final : public VerilatedModule {
  public:
    ...
    // CONSTRUCTORS
    Vriscv_top_biriscv_csr_regfile(Vriscv_top__Syms* symsp, const char* v__name);
    ~Vriscv_top_biriscv_csr_regfile();
    VL_UNCOPYABLE(Vriscv_top_biriscv_csr_regfile);
