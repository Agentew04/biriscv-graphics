...
VL_ATTR_COLD void Vriscv_top_dcache_core_tag_ram___ctor_var_reset(Vriscv_top_dcache_core_tag_ram* vlSelf) {
    ...
    vlSelf->__PVT__addr0_i = VL_SCOPED_RAND_RESET_I(8, __VscopeHash, 1222684595415111315ull);
    ...
    vlSelf->__PVT__addr1_i = VL_SCOPED_RAND_RESET_I(8, __VscopeHash, 5436673784384284525ull);
    vlSelf->__PVT__data1_i = VL_SCOPED_RAND_RESET_I(21, __VscopeHash, 2757824405415766962ull);
    vlSelf->__PVT__wr1_i = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 9576472014007943117ull);
    vlSelf->__PVT__data0_o = VL_SCOPED_RAND_RESET_I(21, __VscopeHash, 15452099297953504952ull);
    for (int __Vi0 = 0; __Vi0 < 256; ++__Vi0) {
        vlSelf->ram[__Vi0] = VL_SCOPED_RAND_RESET_I(21, __VscopeHash, 12779093550319448395ull);
    }
    vlSelf->__PVT__ram_read0_q = VL_SCOPED_RAND_RESET_I(21, __VscopeHash, 3530240296428032956ull);
}
